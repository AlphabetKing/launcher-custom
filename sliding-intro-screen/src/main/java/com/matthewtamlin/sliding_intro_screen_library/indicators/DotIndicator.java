...
public final class DotIndicator extends RelativeLayout implements SelectionIndicator {
	 ...
	 * Dot click listener
	 */
	private Dot.DotCallback dotClickCallback;
	...
	/**
	 * Set listener for click on any dot
	 */
	public void setDotsClickCallback(Dot.DotCallback listener) {
		dotClickCallback = listener;
		if(dotClickCallback!=null) {
			for (int i = 0; i < dots.size(); ++i) {
				Dot dot = dots.get(i);
				dot.setDotClickCallback(dotClickCallback);
			}
		}
	}
